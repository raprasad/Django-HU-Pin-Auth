...
class HarvardAuthZProxyBackend:
    ...
    def __init__(self, authz_validation_info, **kwargs):

        self.authz_validation_info = authz_validation_info  # instance of AuthZProxyValidationInfo
