...
class PinLoginHandler:
    ...
    """
    def __init__(self, request, **access_settings=None):
        self.user = None
    ...
    def handle_authorization(self, request):
        ...
        if self.access_settings is not None:
            authorization_backend  = HarvardAuthZProxyBackend(**self.access_settings)    
        else:
            authorization_backend  = HarvardAuthZProxyBackend()
